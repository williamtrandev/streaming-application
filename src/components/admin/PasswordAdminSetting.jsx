...
import { useChangeAdminPassword } from "../../api/admin";
import { useAuth } from "../../contexts/AuthContext";

const PasswordAdminSetting = ({ authUsername }) => {
    ...
    const { mutate, isPending, isError, error, isSuccess, data } = useChangeAdminPassword();
...
export default PasswordAdminSetting;
