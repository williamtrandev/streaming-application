...
import { useChangeAdminEmail } from "../../api/admin";

const EmailAdminSetting = ({ authEmail, setAuthEmail }) => {
    ...
    const { mutate, isPending, isError, error, isSuccess, data } = useChangeAdminEmail();
    ...
    return (
        <div className="flex w-full gap-4 py-4 md:py-6">
            ...
            <div className="w-full relative">
                ...
                >
                    {authEmail || "You haven't linked your email yet. Link your email now so you can reset your password if you forget it."}
                </div>
                <button
...
export default EmailAdminSetting;
